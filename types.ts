...
export interface ProjectData {
  ...
  apiSettings: {
    ...
    text: {
      provider: 'gemini' | 'ollama' | 'lm-studio' | 'llama-server' | 'omnideploy' | 'anthropic' | 'openai' | 'deepseek' | 'qwen' | 'kimi' | 'other';
      baseUrl: string;
    ...
    promptEngineer: {
      ...
      provider: 'gemini' | 'ollama' | 'lm-studio' | 'llama-server' | 'omnideploy' | 'anthropic' | 'openai' | 'deepseek' | 'other';
